...
const keyWords = document.querySelectorAll(".hero__list-btn__link");
...
const titleName = document.querySelector(".mode__text");
...
mode.addEventListener("click", () => {
	...
	if (theme === "light") {
		...
		titleName.innerHTML = "Light Mode";
	} else {
		document.documentElement.setAttribute("data-theme", "light");
		titleName.innerHTML = "Dark Mode";
	}
});
